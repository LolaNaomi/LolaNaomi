...
<head>
  ...
  <title>Nusantara Hospital - Official Website</title>
...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> (021) 234567890</a>
  ...
  <div class="page-hero bg-image overlay-dark" style="background-image: url(../assets/img/bg-umn.jpg);">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead">Welcome To</span>
        <h1 class="display-4">Nusantara Hospital</h1>
        <h2 class="subhead">-Your Health Care Specialist-</h2>
        <br> <br>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6 py-3 wow fadeInUp">
            <h1 style="font-size: 30px;">About Nusantara Hospital</h1>
            <p class="text-grey mb-4" style="text-align:justify;">
            <br> Nusantara Hospital is a well-known healthcare facility that offers a wide range of medical services. 
            With a team of highly skilled professionals and modern facilities, Nusantara Hospital ensures top-quality patient care. 
            We specialize in various departments such as Pediatric, Ear, Nose, and Throat (ENT), Eye, Dental, Cardiology, General Surgery, Psychiatry ,and Internal Medicine. 
            Nusantara Hospital is dedicated to providing advanced treatments and a comfortable environment for patients. 
            We also actively engage in community outreach programs to promote health and wellness.</p>
            <a href="about.html" class="btn btn-primary">Learn More</a>
          </div>
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
              <img src="../assets/img/Skystar-Ventures-UMN-Building-removebg-preview.png" alt=""> 
            </div>
        </div>
      </div>
    </div> <!-- .bg-light -->
